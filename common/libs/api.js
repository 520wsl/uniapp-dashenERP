 ...
 * @Date: 2019-04-10 00:20:55
 * @Last Modified by: Mad Dragon
 * @Last Modified time: 2019-04-10 00:20:59
...
api.config.baseUrl = "http://localhost:8080/api/"

api.request(url:'user/list',method:'GET').then((res)=>{
...
api.put('user/1', {status: 2}).then((res)=>{
	console.log(JSON.stringify(res))
})
